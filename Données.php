...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insertion dans la table Bastion
    $stmt = $conn->prepare("INSERT INTO Bastion (ContribuableID, PWD, ConfirmationPWD, DateValidation) VALUES (?, ?, ?, NOW())");
    $stmt->bind_param("iss", $contribuableID, $pwd, $pwd);
    $stmt->execute();
